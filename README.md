...
Compatibility Matrix Management: I resolved a version conflict between the cutting-edge Java 26 and the Kotlin 2.0 compiler by manually installing and configuring a stable LTS (Java 21) environment.

Environment Configuration on macOS 12: I bypassed Homebrew limitations on Monterey by manually setting up the compiler binaries and managing terminal PATHs to ensure a smooth build process.
